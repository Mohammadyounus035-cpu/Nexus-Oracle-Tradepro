...
import { AppendOnlyAuditLog, COMPOUND_DERIVATION, COMPOUND_SOURCE, computeCompoundInterest, hashInputs, validateClaim, } from "../src/core/financialVerification.js";
function assertVerificationRecordShape(record) {
    expect(record).toHaveProperty("id");
    expect(record).toHaveProperty("createdAt");
    for (const claimName of ["principal", "final", "gain"]) {
