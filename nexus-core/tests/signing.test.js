...
import { attachSignature, fingerprintPublicKey, generateSigningKeyPair, verifyRecordSignature, } from "../src/core/signing.js";
describe("ed25519 signing", () => {
    it("signs and verifies a financial record", () => {
        ...
        expect(verifyRecordSignature(signed.record, signed.signatureHex, signed.publicKeyPem)).toBe(true);
    });
